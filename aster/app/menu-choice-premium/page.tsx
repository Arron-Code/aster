...
function MenuChoiceContent() {
  ...
  async function continueToOrder(event: FormEvent) {
    ...
    router.push(`/order-premium?${params.toString()}`);
  }
    ...
    <main className="wrap reserve-page">
      <div className="card reserve-shell premium-shell">
        <div className="reserve-header">
          ...
          <button type="button" className="btn secondary" onClick={() => router.push("/frontpage-premium")}>
        ...
        <div className="table-picker-grid option-grid">
          ...
          <button type="button" className="table-picker-card option-card melody" onClick={() => router.push("/reserve-premium")}>
            <span className="option-icon">🎵</span>
