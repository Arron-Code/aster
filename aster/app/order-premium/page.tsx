      ...
      <>
        ...
        <main className="wrap success-media-page">
          ...
          <div className="success-actions">
            <a className="btn" href={`/pay-premium?order=${encodeURIComponent(lastOrderId || "")}`}>Direkt mit PayPal bezahlen</a>
            <a className="btn secondary" href={tableToken ? `/pay-premium?table=${encodeURIComponent(tableToken)}` : "/frontpage-premium"}>Später an der Kasse bezahlen</a>
          </div>
          ...
          <div className="order-header">
            <div>
              ...
              <h1 style={{ fontSize: 34, display: "flex", alignItems: "center", gap: 12 }}>
                <img src="/aster-logo.png" alt="Aster Caffe" className="aster-order-logo" />
                Aster Caffe
              </h1>
            </div>
            {mode !== "pickup" && mode !== "delivery" ? null : (
              <div className="card" style={{ padding: "10px 14px", minWidth: 170 }}>
                <small className="muted">Bestell-ID</small>
