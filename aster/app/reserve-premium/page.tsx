    ...
    <main className="wrap reserve-page">
      <div className="card reserve-shell">
        <div className="reserve-header">
          ...
          <Link className="btn secondary" href="/frontpage-premium">
        ...
        {savedReservation ? (
          <div className="reservation-success">
            ...
            <div className="actions">
              <Link className="btn" href={`/order-premium?table=${encodeURIComponent(savedReservation.tableToken)}`}>
                Jetzt bestellen
              </Link>
              <Link className="btn secondary" href="/reserve-premium">
